...
Тестовые данные: Тестов Николай Первый - логин: “TestNikP” / пароль “testPass_1”
...
Зайти на сайт {TEST}GROW BANK

Авторизоваться пользователем “Тестов Николай Первый”

Зайти на ЭФ “Перевод между счетами”

Шаги воспроизведения:

Перейти на ЭФ «Перевод между счетами»

Выбрать допустимый рублевый счет с остатком более «1000000,00»

Выбрать рублевый счет зачисления

В поле сумма ввести значение «1000000,00»
...
В главном меню нажать на кнопку «Перевод между счетами»

Выбрать счет списания в выпадающем списке с валютой «Юань»

Открыть выпадающий список «Счет зачисления»
...
На главной странице нажать на кнопку «Перевод между счетами»

В выпадающем списке счета списания выбрать Счет типа «Зарплатный» с валютой «Доллар»

В выпадающем списке счета зачисления выбрать Счет типа «Зарплатный» с валютой «Доллар»

В поле сумма указать валидное значение
...
Выбрать файл doc размером 1.1 мб
...
Внизу страницы в облаке нажать кнопку "Add Folder"

В всплывающем окне ввести имя папки
...
Выбрать файл размером 1 мб

Нажать кнопку "Upload file"

Найти файл в списке на облаке
