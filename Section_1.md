## ﻿Раздел 1 Тест-дизайн / Тест-кейсы / Чек-листы
...
**Тестовые данные:** Счет списания: Текущий (Юань) / Счет зачисления: Зарплатный (Юань)
...
**Тестовые данные:** Счет списания: Зарплатный (Доллар) / Счет зачисления: Зарплатный (Доллар)
